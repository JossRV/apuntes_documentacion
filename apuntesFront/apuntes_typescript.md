...
```
    ...
    Y otros elementos de lenguajes de programación orientados a objetos y funcionales. Esto permite escribir codigo mas seguro y
    facil de mantener, especialmente para proyectos grandes y complejos. Typescript es compilado a JS para que se pueda ejecutar en cualquier navegador web, o entorno de servidor que admita JS
```
...
```
    En TS, las variables se pueden declarar usando las palabras clave
    "let y const". Ademas, TS admite el typado estatico o estricto, lo que significa que podemos especificar el tipo de una variable cuando se declaran
