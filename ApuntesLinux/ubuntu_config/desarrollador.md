...
## PHPMYADMIN
~~~
// Para ver las imagenes en visual studio code usa la extencion 'Markdown All in One' usando la vista previa podras ver las imagenes :) o usa `crtl+shift+v`
{
...
~~~
{
    ...
    // Crear Proyecto 
    -> composer create-project laravel/laravel=8.* 'nombreProyecto'
