...
if (2 < 1) {
  ...
  //cuando el caso es falso entarra a este bloque para responder la respuesta negativa
...
// lo quehace el return
// las funciones por lo regular se escriben en camel case
function obtenerAleatorio() {
  return Math.random();
  // lo que hara ese retorno es: regresar un valor entre 0-0.99999999
}
// lo unico que s enecesitaria hacer es invocarlo en un clog

function obtenerNombre() {
  return "daniel";
  //este retorno, mandara el nombre o cadena que se le asigne
}
